...
class AppRoutes {
  ...
  static final menuOptions = <MenuOption>[
    ...
    MenuOption(route: 'listview1', icon: Icons.list_alt_outlined, name: 'List View 1', screen: const ListView1Screen()),
    MenuOption(route: 'listview2', icon: Icons.list_alt_sharp, name: 'List View 2', screen: const ListView2Screen()),
    MenuOption(route: 'alert', icon: Icons.add_alert_sharp, name: 'Alerts', screen: const AlertScreen()),
  ...
  static Map<String, Widget Function(BuildContext)> getAppRoutes() {
    ...
    for (var option in AppRoutes.menuOptions) {
      appRoutes.addAll({option.route: (BuildContext buildContext) => option.screen});
    }
